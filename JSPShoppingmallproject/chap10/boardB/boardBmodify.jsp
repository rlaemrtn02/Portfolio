...
{
	document.frm1.action = "boardBmodify_ok.jsp";
...
try
{
	...
	String strSQL = "SELECT num, title, contents, writer FROM boardB WHERE num = ?";
	...
	%>
		...
		<h3>답변형 게시판 변경</h3>
		<BODY>
		<FORM NAME = "frm1" ACTION = "boardBmodify_ok.jsp" METHOD = "post">
