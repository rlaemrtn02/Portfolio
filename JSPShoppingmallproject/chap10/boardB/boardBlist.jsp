...
%>
<FORM NAME=frm1 ACTION="boardBlist.jsp" METHOD=post>
...
try
{
	...
	String strSQL = "select isnull(count(*), 0) from boardB";
...
<% 
	...
	{	
		...
		strSQL = "SELECT TOP " + pageSize + " num, title, writer, CONVERT(CHAR(10), updatedtm, 120) writedt, readcnt FROM boardB  WHERE num NOT IN (SELECT TOP ";
		strSQL = strSQL  + (currentPage - 1) * pageSize + " num FROM boardB"; 
		if (in_search_value.equals("") == false) {
			strSQL = strSQL + " where " + in_search_key + " like '%" + in_search_value + "%'";
		}
...
%>
			<TR>      
				<TD ALIGN = "center"><a href="boardBview.jsp?pnum=<%= num %>"><%= num %></a></TD>      
...
%>
<br><br>
<FORM NAME = "frm1" ACTION = "boardBwrite.jsp" METHOD = "post">
