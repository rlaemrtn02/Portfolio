...
%>
<FORM NAME=frm1 ACTION="boardDlist.jsp" METHOD=post>
...
%>
			<TR>      
				<TD ALIGN = "center"><a href="boardDview.jsp?pnum=<%= num %>"><%= num %></a></TD>      
				<TD><a href="boardDview.jsp?pnum=<%= num %>"><%= title %></a></TD>      
				<TD ALIGN = "center"><% if (file1 != null && file2 != null) { %><IMG SRC="/chap10/boardD/icon_file.gif"><% } %></TD>      
...
<%
	...
	if (currentGrp > 1){
%>
		[<A href="boardDlist.jsp?PageNum=<%= intGrpStartPage - 1 %>">이전</A>]
<%
	}
...
%>
		[<A href="boardDlist.jsp?PageNum=<%= intIndex %>"><%= intIndex %></A>] &nbsp; 
<%
		intIndex		= intIndex + 1;
...
%>
		[<A href="boardDlist.jsp?PageNum=<%= intIndex %>">다음</A>]
<%
	}
...
%>
<br><br>
<FORM NAME = "frm1" ACTION = "boardDwrite.jsp" METHOD = "post">
