...
<% 
	...
	{	
		...
		strSQL = "SELECT TOP " + pageSize + " num, lock_yn, title, writer, CONVERT(CHAR(10), updatedtm, 120) writedt, readcnt FROM boardC  WHERE num NOT IN (SELECT TOP ";
...
%>
<br><br>
<FORM NAME = "frm1" ACTION = "boardCwrite.jsp" METHOD = "post">
