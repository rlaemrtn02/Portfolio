...
function chkProsess(){
	...
	if(document.frm1.chk.checked == true)
	{
			...
			document.frm1.tel2.value		= document.frm1.tel.value;
...
if (rs    != null) rs.close();
SQL = "select usernm, addr + ' ' + addr addr, tel from members where userid = '" + userid + "'";
rs = stmt.executeQuery(SQL);
      ...
      <tr>
        <td align="center"><table width="800" border="0" cellspacing="1" cellpadding="7" bgcolor="#D7D7D7">
          ...
          <tr>
            ...
            <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT type = text name = addr id = addr value = "<%= addr %>" size = 50 maxlength = 50></td>
          </tr>
          <tr>
            <td align="left" bgcolor="#FFFFFF">주문자 전화</td>
            <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT type = text name = tel id = tel value = "<%= tel %>"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT type="text" name="usernm2" id="usernm2" maxlength="10"></td>
          </tr>
          <tr>
            <td align="left" bgcolor="#FFFFFF">받는자 주소</td>
            <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT type="text" name="addr2" id ="addr2" size="50" maxlength ="50"></td>
          </tr>
          <tr>
            <td align="left" bgcolor="#FFFFFF">받는자 전화</td>
            <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT type="text" name="tel2" id="tel2" maxlength ="30"></td>
          </tr>
        </table></td>
      </tr>
