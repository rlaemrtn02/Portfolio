...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="2" align="left" valign="top">
              ...
              <tr>
								...
								<td align="center" bgcolor="#FFFFFF"><a href="/chap11/admin/goodsinfo_update.jsp?pgoodscd=<%= goodscd %>"><%= goodscd %></a></td>
              ...
              <tr>
								<td colspan = 7 align="center" bgcolor="#FFFFFF"><a href="/chap11/admin/goodsinfo_insert2.jsp">신규등록</a></td>
							</tr>
						</table>
				</table>
        </td>
  ...
  <tr>
        <td align="center" valign="top">
				<table width="800" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="547" height="45" align="left" class="new_tit">그룹별 삭제</td>
          </tr>
          <tr>
            <td colspan="2" align="left" valign="top">
              <form method="get" action="/chap11/admin/group_del.jsp">
    			      <select name="main" style="width: 120px; height: 30px;">
                  <option value=''>대분류선택</option>
                  <option value='O'>OUTER</option>
                  <option value='T'>TOP</option>
                  <option value='B'>BOTTOM</option>
                 </select>
                <select  name="sub" length=3 style="width: 150px; height: 30px;">
                  <option value=''>소분류선택</option>
                    <optgroup label="OUTER">
                    <option value='E'>코트</option>
                    <option value='F'>가디건</option>
                    <option value='G'>점퍼</option>
                    <option value='H'>자켓</option>
                    </optgroup> 
                    <optgroup label="TOP">
                    <option value='I'>반팔</option>
                    <option value='J'>후드</option>
                    <option value='K'>니트</option>
                    <option value='L'>셔츠</option>
                    </optgroup> 
                    <optgroup label="BOTTOM">
                    <option value='A'>반바지</option>
                    <option value='C'>긴바지</option>
                    <option value='R'>스커트</option>
                    </optgroup>
                </select>
